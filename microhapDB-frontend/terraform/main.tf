# Terraform configuration for MicrohapDB Frontend Infrastructure
terraform {
  ...
  # backend "s3" {
  #   bucket = "microhapdb-terraform-state"
...
resource "aws_cloudfront_origin_access_control" "frontend" {
  ...
  description                       = "OAC for MicrohapDB Frontend"
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  comment             = "MicrohapDB Frontend Distribution"
  ...
  tags = {
    Name        = "MicrohapDB Frontend Distribution"
    Environment = var.environment
    Project     = var.project_name
  }
}
